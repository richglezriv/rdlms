...
namespace RD.Business
{
    public class NotificationController
    {
        public void SendConfirmationMail(Entities.User user)
        {
            ...
            {
                throw new Exception("Imposible enviar confirmación de cuenta");
            }
        ...
        public void SendPasswordRecoveryMail(Entities.User user)
        {
            ...
            {
                throw new Exception("Imposible enviar reestablecimiento de contraseña");
            }
        }
        ...
        private String GetPasswordRecoveryEmailBody(String resetUri)
        {
            StringBuilder builder = new StringBuilder();
            String imageSource = String.Format("{0}branding/pleca_uxns.jpg", Properties.Settings.Default.confirmationUri);
            builder.AppendLine(@"<!DOCTYPE html><html><head><title>Reestablecer Contraseña</title><style>
            ...
            builder.AppendLine(String.Format("<img id='u81_img' alt='' class='block' height='55' src='{0}' width='500' /> </div><div id='u115-4' class='clearfix colelem'><p>Correo de Recuperación de contraseña</p></div><div id='u130-25' class='clearfix colelem'><p>Hemos recibido tu solicitud para reestablecer tu contraseña en nuestro sistema de cursos en l&iacute;nea. Para hacer esto debes seguir esta liga:</p><p>&nbsp;</p>", imageSource));
            builder.AppendLine(String.Format("<p id='u130-7'><a href='{0}'>reestablecer contrase&ntilde;a</a></p><p>&nbsp;</p><p>(Si al dar click no te conecta a nuestro sitio te pedimos copiar la</p><p>direcci&oacute;n a tu navegador e intentar de manera directa)</p>", resetUri));
