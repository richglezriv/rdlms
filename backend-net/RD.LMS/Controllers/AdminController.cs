...
namespace RD.LMS.Controllers
{
   public class AdminController : Controller
   {
      ...
      public ActionResult Save(String data, string csrftoken)
      {
         ...
         Utilities.LogTransaction("Registro curso", _errorCode, model.status);
         return Json(model);
      }
      ...
      public ActionResult Delete(string data, string csrftoken)
      {
         ...
         Utilities.LogTransaction("Eliminar curso", _errorCode, model.status);
         return Json(model);
      }
      ...
      public ActionResult DeleteUser(String data, string csrftoken)
      {
         ...
         Utilities.LogTransaction("Eliminar usuario", _errorCode, model.status);
      ...
      public ActionResult SaveUser(String data, String csrftoken)
      {
         ...
         Utilities.LogTransaction("Atualizar usuario", _errorCode, model.status);
         return Json(model);
      }
      ...
      public ActionResult RegisterUser(String data)
      {
         ...
         Utilities.LogTransaction("Actualizacion usuario", _errorCode, model.status);
         return Json(model);
      }
      ...
      public ActionResult ClearUserScorm(String data, string csrftoken)
      {
         ...
         Utilities.LogTransaction("Reestablecer Cursos", _errorCode, model.status);
         return Json(model);
      }
