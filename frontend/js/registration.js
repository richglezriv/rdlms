jQuery(function($){
	...
	function validateData(data){
		...
		if(!(patterns.name).test(data.last_name)){
			errors.last_name = 'El apellido paterno proporcionado es inválido.';
		}
		if(!(patterns.name).test(data.second_last_name)){
			errors.second_last_name = 'El apellido materno proporcionado es inválido.';
		}
		...
		if(data.confirm_password !== data.password){
			errors.confirm_password = 'La confirmación de tu contraseña es diferente a tu contraseña.';
		}
		if(!data.terms){
	...
	function getFormData(){
		var data = {
			...
			last_name: $.trim($('#input-last_name').val()),
			second_last_name: $.trim($('#input-second_last_name').val()),
